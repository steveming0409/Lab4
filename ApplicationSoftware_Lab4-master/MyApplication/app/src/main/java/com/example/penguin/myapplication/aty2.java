package com.example.penguin.myapplication;
...
public class aty2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioGroup rg_sugar = (RadioGroup) findViewById(R.id.radioGroup_sugar);
        ...
        RadioGroup rg_ice =(RadioGroup) findViewById(R.id.radioGroup_ice);
